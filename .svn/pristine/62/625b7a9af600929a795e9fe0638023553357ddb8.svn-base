...
public class SysDictController {
	...
	@RequestMapping("/listsysdictbytype")
	@ResponseBody
	public List<SysDictInfo> listSysDictByType(String sysDictType) {
		if (StringUtil.isEmpty(sysDictType)) {
			return new ArrayList<>();
		}
		return sysDictService.listSysDictInfoByType(sysDictType);
	}
	
	@RequestMapping("/listproduceinfo")
	@ResponseBody
	public List<SysDictInfo> listProduceInfo() {
		return sysDictService.listProduceInfo();
	}
}
